    ...
    <AppScreen>
      ...
      >
        ...
        <View style={styles.heroFacts}>
          ...
          <View style={styles.heroFact}>
            ...
            <MoneyAmount
              value={snapshot.summary.spendingBalanceMinor}
              hidden={hidden}
              size={18}
              color="#FFFFFF"
            />
      ...
      <View style={styles.quickRow}>
        <IconButton
          ...
          label="记支出"
          onPress={() => goAdd("EXPENSE")}
        />
        <IconButton
          name="add-circle-outline"
          label="记收入"
          onPress={() => goAdd("INCOME")}
        />
        <IconButton
          name="swap-horizontal-outline"
          label="转账"
          onPress={() => goAdd("TRANSFER")}
        />
        <IconButton
          name="sparkles-outline"
          label="工资分配"
          onPress={() => router.push("/salary-allocation" as never)}
        />
        <IconButton
                ...
                <View key={item.categoryId}>
                  ...
                  <View style={styles.budgetRow}>
                    ...
                    >
                      {hidden
                        ? "•••• / ••••"
                        : `${formatMoney(item.actualMinor)} / ${formatMoney(item.budgetMinor)}`}
                    </Text>
                    <ProgressBar
                ...
                <View key={item.id}>
                  ...
                  <View style={styles.transactionRow}>
                    ...
                    <View style={styles.transactionText}>
                      <Text style={[styles.itemTitle, { color: colors.text }]}>
                        {item.categoryName ?? kindLabel[item.kind]}
                      </Text>
                      <Text
...
const styles = StyleSheet.create({
  ...
  cycle: { color: "#FFFFFF", opacity: 0.78, fontSize: 12 },
