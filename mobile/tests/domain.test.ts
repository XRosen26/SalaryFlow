...
test('工资日位于短月时使用当月最后一天', () => {
  assert.deepEqual(cycleRange('2026-02-28', 31), { start: '2026-02-28', end: '2026-03-31' });
  assert.deepEqual(cycleRange('2026-02-27', 31), { start: '2026-01-31', end: '2026-02-28' });
});

test('自然月和工资周期使用半开区间', () => {
  assert.deepEqual(budgetPeriodRange('2026-09-12', 'CALENDAR_MONTH', 10), { start: '2026-09-01', end: '2026-10-01' });
  assert.deepEqual(budgetPeriodRange('2026-09-12', 'SALARY', 10), { start: '2026-09-10', end: '2026-10-10' });
});
