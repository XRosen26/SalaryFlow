...
版本：V1 已确认架构基线｜2026-09-06｜应用0.3.0已实现。实际采用Electron备选、Node SQLite、数据库schema 3；真实DDL与设计差异见 [IMPLEMENTATION.md](./IMPLEMENTATION.md)。下文候选模型保留用于设计追溯，不代表所有P1/P2表已实现。
