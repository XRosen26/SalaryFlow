...
Android设置页提供与桌面一致的六套配色。首页“当前可安心支出”卡和预算行共享七级预算使用率颜色，保证相同状态得到相同提示。快速记账以分组、图标和文字完整展示动态分类，分类较多时允许纵向滚动，并保留分类管理入口。
...
版本：V1 已确认设计基线｜更新至 Windows 0.7.1 / Android 0.3.0。本文含后续交互目标，实际范围及差异见 [IMPLEMENTATION.md](./IMPLEMENTATION.md)。
